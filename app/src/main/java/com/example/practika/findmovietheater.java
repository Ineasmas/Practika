...
public class findmovietheater extends AppCompatActivity {
    TextView tvInfo;
    EditText tvName;
    findmovietheater.MyTask mt;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_findmovietheater);
        tvInfo = (TextView) findViewById(R.id.tvInfo);
        tvName = (EditText) findViewById(R.id.editTextTextPersonName);
    }
    public void onclick(View v) {
        mt = new findmovietheater.MyTask();
    ...
    class MyTask extends AsyncTask<String, Void, ArrayList<String[]>> {
        ...
        protected void onPostExecute(ArrayList<String[]> result) {
            ...
            findmovietheater.ClAdapter clAdapter=new
                    findmovietheater.ClAdapter(tvInfo.getContext(),result);
